...
<p align="center">
  ...
  <img src="screenshots/app-ui-2.png" width="48%" alt="Receive File" />
  <br/>
  <img src="screenshots/app-ui-3.png" width="60%" alt="Device Portal" />
</p>
...
- 📸 **QR Connect (TichPhong Direct)**: Web-based high-speed file sharing via QR code, no app required *(Coming Soon in v2.0.0)*.
...
<p align="center">
  ...
  <img src="screenshots/app-ui-2.png" width="48%" alt="Nhận File" />
  <br/>
  <img src="screenshots/app-ui-3.png" width="60%" alt="Device Portal" />
</p>
...
- 📸 **QR Connect (TichPhong Direct)**: Chia sẻ file siêu tốc qua mã QR trên trình duyệt, không cần cài app *(Sắp ra mắt trong phiên bản 2.0.0)*.
